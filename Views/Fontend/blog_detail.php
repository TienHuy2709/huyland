      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            <h2 class="mb-3"><?php echo $detail->ten; ?></h2>
            <p>Ngày đăng : <?php echo $detail->ngaydang; ?></p>
            <?php echo $detail->noidung; ?>
            <p>Người đăng : Admin</p>
            <p>Lượt xem : <?php echo $detail->luotxem; ?> người</p>
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio align-self-md-center mr-4">
                <img src="<?php  echo WEBROOT; ?>/asset/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
              </div>
            ...
            <div class="pt-5 mt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="<?php  echo WEBROOT; ?>/asset/images/person_1.jpg" alt="Image placeholder">
                  </div>
